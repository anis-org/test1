...
terraform {
  backend "azurerm" {
    ...
    storage_account_name = "anisorgterraformbackend"
...
module "create_resource_group" {
  source = "git::https://github.com/anis-org/JM-Infra-Central.git//modules/resource_group?ref=main"
...
module "create_app" {
  source = "git::https://github.com/anis-org/JM-Infra-Central.git//modules/web_app_linux?ref=main"
...
#  source = "git::https://github.com/anis-org/JM-Infra-Central.git//modules/private_endpoint?ref=main"
#
  # Input variables
...
#  source = "git::https://github.com/anis-org/JM-Infra-Central.git//modules/vnet_integration?ref=main"
...
module "create_storage_account" {
  source = "git::https://github.com/anis-org/JM-Infra-Central.git//modules/storage_account?ref=main"
...
module "create_storage_container" {
  source = "git::https://github.com/anis-org/JM-Infra-Central.git//modules/storage_container?ref=main"
...
module "create_storage_share" {
  source = "git::https://github.com/anis-org/JM-Infra-Central.git//modules/storage_share?ref=main"
